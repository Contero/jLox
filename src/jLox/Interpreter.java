...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void>
{
    ...
    public Object visitTernaryExpr(Expr.Ternary expr)
    {
        ...
        Object ifFalse = evaluate(expr.ifFalse);
    ...
    public Void visitClassStmt(Stmt.Class stmt)
    {
        ...
        if (stmt.superclass != null)
        {
            ...
            {
                throw new RuntimeError(stmt.superclass.name, "Superclass must be a class, you turd.");
            }
        }
    ...
    public Void visitVarStmt(Stmt.Var stmt)
    {
        ...
        {
            value = new Environment.Undefined();
        }
    ...
    {
        if (!(left instanceof Double && right instanceof Double))
            throw new RuntimeError(operator, "Operands must be numbers n'shit");
    }

    private void checkBooleanOperands(Token operator, Object operand)
    {
        if(!(operand instanceof Boolean))
            throw new RuntimeError(operator, "Operand must resolve to boolean");
    }
}
